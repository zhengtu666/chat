package com.example.chat.common.bean;
...
public class ResultMsg {
    ...
    public static ResultMsg success(Object resInfo){
        return new ResultMsg(ResultCode.SUCCESS,"success",resInfo);
    }

    public static ResultMsg success(){
        return new ResultMsg(ResultCode.SUCCESS,"success",null);
    }

    public static ResultMsg  failure(String stateInfo){
        return new ResultMsg(ResultCode.ERROR,stateInfo,null);
    }
